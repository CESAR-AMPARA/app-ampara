...
- [ ] Task: Program the global **Ocorrências** tab timeline view to render registered incidents with automatic date/time stamping.
- [ ] Task: Bind form submissions to insert new occurrences into both the main occurrence log and the specific student or class's historical behavior log timeline, firing Toast success signals.
- [ ] Task: Conduct accessibility and styling checks, ensuring modal focus trap, responsive grids, and proper keyboard navigation.
- [ ] Task: Conductor - User Manual Verification 'Phase 2: Coordination Occurrences Modal, Timelines & Interactivity' (Protocol in workflow.md)